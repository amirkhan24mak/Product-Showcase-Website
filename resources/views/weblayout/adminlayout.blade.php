    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="{{url("/dashboard-home")}}"><img src="{{url("assent/images/Untitled_design-removebg-preview.png")}}" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="{{url("/dashboard-home")}}"><img src="{{url("assent/images/ATC png2.png")}}" alt="logo"/></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url("/dashboard-home/addcatagory")}}">Add Category</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url("/dashboard-home/listcatagory")}}">List Category</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#">Add Gallery Images</a></li>
                <li class="nav-item"><a class="nav-link" href="#">List Gallery Images</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
